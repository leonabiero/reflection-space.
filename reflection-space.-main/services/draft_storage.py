...
def save_draft(case_ref, doc_type, language, content, created_by="", created_by_role=""):
    ...
    # Returned so callers can identify the newly created draft for
    # subsequent operations such as audit logging. The return value is
    # intentionally preserved for existing call sites.
    return new_id
