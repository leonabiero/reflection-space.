...
def check_and_record(user_name, max_per_hour=DEFAULT_MAX_PER_HOUR):
    ...
    Returns (allowed, current_count):
        ...
        current_count -- how many reflections this user has generated
                          ...
                          caller can show "18 of 20" type messaging if it
                          ever wants to).
    ...
    try:
        ...
        try:
            with conn.cursor() as c:
                ...
                # Reliability boundary: serialize the check + insert for
                # this user at the database transaction level. Without this,
                # two simultaneous requests can both observe the same count
                # below the limit and both insert, exceeding max_per_hour.
                c.execute(
